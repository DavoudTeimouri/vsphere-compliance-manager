...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/vsphere-compliance-manager.git
   cd vsphere-compliance-manager
   ```
3. Add the upstream remote:
   ```bash
   git remote add upstream https://github.com/your-org/vsphere-compliance-manager.git
   ```
